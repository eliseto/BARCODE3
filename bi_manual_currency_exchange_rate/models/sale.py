...
class SaleOrder(models.Model):
    ...
    sale_manual_currency_rate_active = fields.Boolean('Tasa de cambio manual')
...
class SaleOrderLine(models.Model):
    ...
    def product_id_change(self):
        ...
        if self.order_id.sale_manual_currency_rate_active:
            compute_rate = 1.0 / self.order_id.sale_manual_currency_rate
            currency_rate = compute_rate/company.currency_id.rate
