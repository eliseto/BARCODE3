...
class PurchaseOrder(models.Model):
	...
	purchase_manual_currency_rate_active = fields.Boolean('Tasa de cambio manual')
...
class PurchaseOrderLine(models.Model):
	...
	def _prepare_stock_moves(self, picking):
		...
		if self.order_id.purchase_manual_currency_rate_active:
			compute_rate = 1.0 / self.order_id.purchase_manual_currency_rate
			price_unit = self.order_id.currency_id.round((self.price_unit)/compute_rate)
	...
	def _onchange_quantity(self):
		...
		if not seller:
			...
			if self.order_id.purchase_manual_currency_rate_active:
				compute_rate = 1.0 / self.order_id.purchase_manual_currency_rate
				price_unit = self.product_id.standard_price * compute_rate
