...
class LibroContableReport(models.TransientModel):
    ...
    def export_xls(self):
        ...
        if self.libro == 'diario':
            return self.env.ref('l10n_gt_sat.libro_contable_diario_xlsx').report_action(self,data=datas)
        else:
            return self.env.ref('l10n_gt_sat.libro_contable_mayor_xlsx').report_action(self,data=datas)
